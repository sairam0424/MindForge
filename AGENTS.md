...
MindForge v12.0.0 is an agentic intelligence framework distributed as the `mindforge-cc` npm package. Two package roots:
...
- **Other roots:** `.mindforge/` (engine configs, 232 skills, personas, governance), `.agent/` (10 hooks — 11 registered, 221 workflows, `CLAUDE.md` protocols), `.planning/` (STATE.md, ROADMAP.md, audit), `docs/`, `examples/`, `tests/` (142 `*.test.js`).
