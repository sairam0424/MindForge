...
- **Other roots:** `.mindforge/` (engine configs, 232 skills, personas, governance), `.agent/` (9 hooks — 8 registered, 221 workflows, `CLAUDE.md` protocols), `.planning/` (STATE.md, ROADMAP.md, audit), `docs/`, `examples/`, `tests/` (136 `*.test.js`).
