...
<objective>
Design comprehensive build-opt system architecture with best practices and production-ready patterns.
</objective>

<execution_context>
@.mindforge/skills/build-system-optimization/SKILL.md
</execution_context>

<context>
Skills Directory: `.mindforge/skills/build-system-optimization/`
State: Analyzes requirements, constraints, and scale to generate optimized build-opt architecture.
</context>
