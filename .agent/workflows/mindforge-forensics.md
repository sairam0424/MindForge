...
Post-mortem investigation for failed or stuck MindForge workflows. Analyzes git history,
...
3. {Recovery command if applicable — e.g., `/mindforge-resume-work`, `/mindforge-execute-phase N`}

---

*Report generated by `/mindforge-forensics`. All paths redacted for portability.*
```
