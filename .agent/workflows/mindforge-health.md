...
```bash
node ".agent/bin/mindforge-tools.cjs" validate health $REPAIR_FLAG
```
...
- [E001] config.json: JSON parse error at line 5
  Fix: Run /mindforge-health --repair to reset to defaults

- [E002] PROJECT.md not found
  Fix: Run /mindforge-new-project to create
```
...
```
---
N issues can be auto-repaired. Run: /mindforge-health --repair
```
</step>
...
```
Would you like to run /mindforge-health --repair to fix N issues automatically?
```
...
```bash
node ".agent/bin/mindforge-tools.cjs" validate health
```
