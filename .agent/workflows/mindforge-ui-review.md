<purpose>
Retroactive 6-pillar visual audit of implemented frontend code. Standalone command that works on any project — MindForge-managed or not. Produces scored UI-REVIEW.md with actionable findings.
</purpose>
...
```bash
UI_AUDITOR_MODEL=$(node ".agent/bin/mindforge-tools.cjs" resolve-model mindforge-ui-auditor --raw)
```

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 MindForge ► UI AUDIT — PHASE {N}: {name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
**If `SUMMARY_FILES` empty:** Exit — "Phase {N} not executed. Run /mindforge-execute-phase {N} first."
...
```markdown
Read .agent/agents/mindforge-ui-auditor.md for instructions.
...
Task(
  ...
  subagent_type="mindforge-ui-auditor",
...
- `/mindforge-verify-work {N}` — UAT testing
- `/mindforge-plan-phase {N+1}` — plan next phase
...
```bash
node ".agent/bin/mindforge-tools.cjs" commit "docs(${padded_phase}): UI audit review" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-REVIEW.md"
```
...
- [ ] mindforge-ui-auditor spawned with correct context
