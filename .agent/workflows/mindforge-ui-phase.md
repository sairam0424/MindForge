<purpose>
Generate a UI design contract (UI-SPEC.md) for frontend phases. Orchestrates mindforge-ui-researcher and mindforge-ui-checker with a revision loop. Inserts between discuss-phase and plan-phase in the lifecycle.
...
```bash
UI_RESEARCHER_MODEL=$(node ".agent/bin/mindforge-tools.cjs" resolve-model mindforge-ui-researcher --raw)
UI_CHECKER_MODEL=$(node ".agent/bin/mindforge-tools.cjs" resolve-model mindforge-ui-checker --raw)
```

Check config:

```bash
UI_ENABLED=$(node ".agent/bin/mindforge-tools.cjs" config-get workflow.ui_phase 2>/dev/null || echo "true")
```

**If `UI_ENABLED` is `false`:**
```
UI phase is disabled in config. Enable via /mindforge-settings.
```
Exit workflow.
...
Recommended: run /mindforge-discuss-phase {N} first to capture design preferences.
...
## 5. Spawn mindforge-ui-researcher

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 MindForge ► UI DESIGN CONTRACT — PHASE {N}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```markdown
Read .agent/agents/mindforge-ui-researcher.md for instructions.
...
Template: .agent/mindforge/templates/UI-SPEC.md
</output>
...
Task(
  ...
  subagent_type="mindforge-ui-researcher",
...
## 7. Spawn mindforge-ui-checker

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 MindForge ► VERIFYING UI-SPEC
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```markdown
Read .agent/agents/mindforge-ui-checker.md for instructions.
...
Task(
  ...
  subagent_type="mindforge-ui-checker",
...
- Re-spawn mindforge-ui-researcher with revision context:
...
2. Edit manually — open UI-SPEC.md in editor, re-run /mindforge-ui-phase
...
```bash
node ".agent/bin/mindforge-tools.cjs" commit "docs(${padded_phase}): UI design contract" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-SPEC.md"
```
...
- [ ] mindforge-ui-researcher spawned with correct context and file paths
- [ ] UI-SPEC.md created in correct location
- [ ] mindforge-ui-checker spawned with UI-SPEC.md
