...
Usage: /mindforge-list-phase-assumptions [phase-number]
Example: /mindforge-list-phase-assumptions 3
```
...
```
What's next?
1. Discuss context (/mindforge-discuss-phase ${PHASE}) - Let me ask you questions to build comprehensive context
2. Plan this phase (/mindforge-plan-phase ${PHASE}) - Create detailed execution plans
