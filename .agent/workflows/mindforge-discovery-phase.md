...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /mindforge-research-phase instead, which produces RESEARCH.md.
</purpose>
...
See .agent/mindforge/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using .agent/mindforge/templates/discovery.md structure:
...
1. **Scope the discovery** using .agent/mindforge/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from .agent/mindforge/templates/discovery.md
...
Use .agent/mindforge/templates/discovery.md.
...
1. Discuss phase context (/mindforge-discuss-phase [current-phase])
2. Create phase plan (/mindforge-plan-phase [current-phase])
