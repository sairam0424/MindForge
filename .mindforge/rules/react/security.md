---
name: react-security-rules
description: Language-correct security standards for React (dangerouslySetInnerHTML/XSS, unsafe URL schemes, Server Action validation, CSP, client-secret exposure).
paths: ["**/*.tsx", "**/*.jsx"]
---
# React Security
