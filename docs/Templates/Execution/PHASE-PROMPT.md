...
> **Note:** Planning methodology is in `agents/mindforge-planner.md`.
...
@docs/Templates/Execution/SUMMARY.md
[If plan contains checkpoint tasks (type="checkpoint:*"), add:]
@.agent/mindforge/checkpoints.md  # Assuming it exists or will be added
</execution_context>
...
<!-- For checkpoint task examples and patterns, see @.agent/mindforge/references/checkpoints.md -->
...
**Wave is pre-computed:** Wave numbers are assigned during `/mindforge-plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
See `.agent/mindforge/references/tdd.md` for TDD plan structure.
...
- MindForge Principal presents to user
- User responds
- MindForge Principal resumes agent with `resume: agent_id`
...
<execution_context>
@.agent/mindforge/workflows/execute-plan.md
@.agent/mindforge/templates/summary.md
@.agent/mindforge/references/checkpoints.md
</execution_context>
...
See `.agent/mindforge/templates/user-setup.md` for full schema and examples
...
See `.agent/mindforge/workflows/verify-phase.md` for verification logic.
