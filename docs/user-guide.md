# MindForge User Guide (v11.9.2)

This guide gets you from install to productive, with the minimum needed to run MindForge in a real project.

> **v11.9.2 Stats:** 35 workflows · 221 slash commands · 232 engine skills · 216 personas · 0 CVEs · 258/258 IQ200 checks passing
...
mindforge --version       # Print installed version (e.g. 11.9.2) and exit 0
```
