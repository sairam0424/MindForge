# MindForge User Guide (v11.9.7)

This guide gets you from install to productive, with the minimum needed to run MindForge in a real project.

> **v11.9.7 Stats:** 35 workflows · 221 slash commands · 232 engine skills · 216 personas · 0 CVEs · 258/258 IQ200 checks passing
...
mindforge --version       # Print installed version (e.g. 11.9.7) and exit 0
```
